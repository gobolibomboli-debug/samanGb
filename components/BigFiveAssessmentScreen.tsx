...
import { BIG_FIVE_QUESTIONS } from '../services/bigFiveService';
import { useLanguage } from '../contexts/LanguageContext';
import JourneyProgress from './JourneyProgress';
import { BigFiveAssessmentState } from '../types';

interface BigFiveAssessmentScreenProps {
  assessmentState: BigFiveAssessmentState;
  onAnswer: (questionId: number, score: number) => void;
  onBack: () => void;
  onFinishRandomly: () => void;
}

const BigFiveAssessmentScreen: React.FC<BigFiveAssessmentScreenProps> = ({ assessmentState, onAnswer, onBack, onFinishRandomly }) => {
  ...
  const likertOptions = [
    { labelKey: 'bfq_likert_1', value: 1 },
    { labelKey: 'bfq_likert_2', value: 2 },
    { labelKey: 'bfq_likert_3', value: 3 },
    { labelKey: 'bfq_likert_4', value: 4 },
    { labelKey: 'bfq_likert_5', value: 5 },
  ];
...
export default BigFiveAssessmentScreen;